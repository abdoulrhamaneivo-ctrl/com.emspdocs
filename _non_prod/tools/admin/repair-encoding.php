...
$markers = ['Ãƒ', 'Ã‚', 'Ã¢â‚¬â„¢', 'Ã¢â‚¬Å“', 'Ã¢â‚¬', 'Ã¯Â¿Â½'];
$targets = [
    ['journal', 'title'],
    ['journal', 'content'],
        ...
        <div class="sb-card mb-4">
            <div class="sb-card-header">
                <div class="sb-card-title">
                    <i class="bi bi-type me-2"></i>Audit des caractÃ¨res cassÃ©s
                </div>
            </div>
            <div class="sb-card-body">
                <div class="alert alert-warning mb-3" role="alert">
                    ...
                    et affiche quelques exemples avant une Ã©ventuelle correction manuelle.
                </div>
