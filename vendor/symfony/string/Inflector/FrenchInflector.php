...
final class FrenchInflector implements InflectorInterface
{
    ...
    private const PLURALIZE_REGEXP = [
        ...
        // Words finishing with "eu" are pluralized with a "x" excepted "pneu", "bleu", "̩meu"
        // Les mots finissant en "eu" prennent un "x" au pluriel sauf "pneu", "bleu", "̩meu"
        ...
        // Aspirail, bail, corail, ̩mail, fermail, soupirail, travail, vantail et vitrail font leur pluriel en -aux
