...
class Text
{
    ...
    {
        $default = [
            'ellipsis' => 'â€¦', 'exact' => true, 'html' => false, 'trimWidth' => false,
        ];
     ...
     */
    public static function excerpt(string $text, string $phrase, int $radius = 100, string $ellipsis = 'â€¦'): string
    {
        if ($text === '' || $phrase === '') {
