...
final readonly class BigInteger extends BigNumber
{
     ...
     *                                   âš ï¸ WARNING: the default rounding mode was kept as Down for backward
    ...
    public function sqrt(RoundingMode $roundingMode = RoundingMode::Down): BigInteger
    {
        ...
        // For Half* modes, compare our number to the midpoint of the interval [sÂ², (s+1)Â²[.
        // The midpoint is sÂ² + s + 0.5. Comparing n >= sÂ² + s + 0.5 with remainder = n âˆ’ sÂ²
